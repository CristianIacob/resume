const contentPDF = {
  content: [
    ...
    {
      text: ['Chapter "', { textReference: "header1" }, '" is on page number ', { pageReference: "header1" }],
    },
    {
      text: ['Chapter "', { textReference: "subheader1" }, '" is on page number ', { pageReference: "subheader1" }],
    },
    {
      text: ['Chapter "', { textReference: "subheader2" }, '" is on page number ', { pageReference: "subheader2" }],
    },
    {
      text: ['Chapter "', { textReference: "subheader3" }, '" is on page number ', { pageReference: "subheader3" }],
    },
    {
