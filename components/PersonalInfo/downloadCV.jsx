...
function DownloadCV() {
  ...
  return (
    <button
      className="my-5 w-4/5 text-gray-700 shadow hover:shadow-md focus:outline-none font-bold py-2 px-4 rounded-lg capitalize flex items-center font-sans text-xs"
